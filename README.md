...
```
### Usage
I was inspired by the NES audio expansion chipsets N163 and FDS, where waveforms where custom waveforms can be drawn to make music. I wanted to make my own 'Waveform Editor' where I can import waveforms and wavetables from .wav files or oscilloscope images. 
